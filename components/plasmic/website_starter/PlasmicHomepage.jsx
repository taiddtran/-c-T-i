...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: AUjYGwiviYp0/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__ad7Ir)} />
              <div className={classNames(projectcss.all, sty.column__kfI2K)} />
            </div>
            <h1
...
const PlasmicDescendants = {
  root: ["root", "section", "columns", "h1", "text"],
  section: ["section", "columns", "h1", "text"],
  columns: ["columns"],
  h1: ["h1"],
  text: ["text"]
};

...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: vzCJyFzjnXyO/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__qBXtZ)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___7JBhM)}
              role={"img"}
            />
          ),
